    ...
    <section class="hero-section set-bg" data-setbg="{{ asset('/frontend') }}/img/bg.jpg">
        <div class="container">
            <div class="hero-text text-white">
                <h2>Ayo Daftar Ke Sekolah Kami</h2>
            ...
            <div class="row course-items-area">
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 finance">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/1.jpg">
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 design">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/2.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/2.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 web">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/3.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/3.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 photo">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/4.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/4.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 finance">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/5.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/5.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 design">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/6.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/6.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 web">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/7.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/7.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
                ...
                <div class="mix col-lg-3 col-md-4 col-sm-6 photo">
                    <div class="course-item">
                        <div class="course-thumb set-bg" data-setbg="{{ asset('/frontend') }}/img/courses/8.jpg">
                            <div class="price">Price: $15</div>
                        </div>
                        <div class="course-info">
                            <div class="course-text">
                            ...
                            <div class="course-author">
                                <div class="ca-pic set-bg" data-setbg="{{ asset('/frontend') }}/img/authors/8.jpg">
                                </div>
                                <p>William Parker, <span>Developer</span></p>
                            </div>
                        </div>
